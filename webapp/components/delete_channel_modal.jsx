...
<<<<<<< HEAD
                    <FormattedMessage
                        ...
                        defaultMessage='This will delete the {term} from the team and make its contents inaccessible for all users. Are you sure you wish to delete the {display_name} {term}?'
                        values={{
